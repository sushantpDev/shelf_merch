...
describe('RBAC + ABAC (must-have §11.1)', () => {
  ...
  it('both company admin and entity manager can import campaign recipients (campaignOps RBAC)', async () => {
    ...
    // Company admin now shares the entity manager's campaign-ops privileges.
