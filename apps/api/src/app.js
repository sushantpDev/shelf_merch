...
import shopAuthRoutes, { claimRedeemRouter } from './modules/storefront/shopAuth.routes.js';
...
export function createApp() {
  ...
  api.use('/storefront/:shopId/auth', shopAuthRoutes);
  api.use('/storefront/auth', claimRedeemRouter);
